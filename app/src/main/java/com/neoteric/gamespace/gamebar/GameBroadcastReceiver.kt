 ...
 */
package com.neoteric.gamespace.gamebar
...
class GameBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val GAME_START = "com.neoteric.gamespace.action.GAME_START"
        const val GAME_STOP = "com.neoteric.gamespace.action.GAME_STOP"
    }
}
